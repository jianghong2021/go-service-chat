...
func InitApiRouter(engine *gin.Engine) {
	...
	//用户管理
	users := engine.Group("/u", middleware.JwtApiMiddleware)
	{
		users.GET("/users", controller.GetKefuList)
		users.POST("/add", controller.PostKefuRegister)
		users.POST("/edit", controller.PostKefuInfo)
		users.POST("/delete", controller.DeleteKefuInfo)
	}
